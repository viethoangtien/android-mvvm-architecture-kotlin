...
class Repository @Inject constructor(val apiService: ApiService) {
    ...
    fun getNotification(data: MutableMap<String, Any?>) = apiService.getNotification(
        "${ApiConstant.RequestParam.BEARER}eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..94ZUAl33x7ZEpy47vb6qQmyQMYekFiFG0-pywb4O0tg",
        data
    )
        .backgroundThreadProcess()

    fun getConstruction(pageIndex: Int) =
        apiService.getConstruction("http://api.production.beetechdev.vn/api/v1/kouji", pageIndex).backgroundThreadProcess()
}